...
class Encoder_GRU(nn.Module):
    ...
    def forward(self, x):
        ...
        output_GRU=self.output_GRU(out_2).view(-1,self.w,3)
...
class Encoder_CNN_1D(nn.Module):
    def __init__(self, input_shape_1D, input_shape_2D, dropout, w, hidden_dim=64, output_size=64, kernel_size=3, stride=1, padding=1):
        ...
        self.fc1 = nn.Linear(64, 25*output_size) #self.fc1 = nn.Linear(128, 64)
        self.dropout1 = nn.Dropout(0.2)
        self.fc2 = nn.Linear(25*output_size, 25*output_size) #self.fc2 = nn.Linear(64, 32)
        ...
        self.output_C2 = nn.Linear(528 * w, 64) #self.output_C2 = nn.Linear(25*32+w*128, 6 * w)
    ...
    def forward(self, x, x_1):
        ...
        print(f"Shape of model_2_output_1: {model_2_output_1.shape}")

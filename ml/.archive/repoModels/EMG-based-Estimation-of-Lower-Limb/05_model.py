#have docker file add access to utilities folder to use model from this file
...
if __name__ == "__main__":
    ...
    for subject in range(1, 7):
        ...
        r2, rmse, nrmse, y_true, y_pred = train_fit(
            ...
            shift=shift, # Output time point distance from the last input's point on the time series
